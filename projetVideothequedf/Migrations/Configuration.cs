namespace projetVideothequedf.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<projetVideothequedf.DAL.VideothequeContext>
    {
        ...
        protected override void Seed(projetVideothequedf.DAL.VideothequeContext context)
        {
           ...
           a => a.id,
           new Films { Acteur_id = 2, Genre = "Comedy", titre = "Fantomas", price = 12, year = 1966, duree = 100, icon = "~/photos/fantomas.png" }, new Films { Acteur_id = 6, Genre = "Comedy", titre = "Un prince à new york", price = 12, year = 1996, duree = 120, icon = "~/photos/prince.png",idRealisateur=1,exemplaires=2 },
